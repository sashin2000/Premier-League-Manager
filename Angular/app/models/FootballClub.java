...
/*
* This is class FootballClub
* It is inherited from the abstract class SportsClub
* All the properties related to match (like match statistics) are included in this class
* Default sorting method (according to points) has been implemented using Comparable interface
*
...
/*    //This method is only for testing purpose
    ...
    public int compareTo(FootballClub otherClub) {
        ...
        // If the points are equal for both clubs, secondly compare them with goal difference
        if(result == 0){
        ...
        // If the result is -1 the club is kept in the same position in the array list
        // If the result is +1 the club is swapping its position
        return result;
    }

    @Override
    public String toString() {
        return "Club name : " + getClubName() + "\nClub location : " + getClubLocation() + "\nClub Manager : " + getClubManager() + "\nNumber of Wins : " + numberOfWins + "\nNumber of Draws : " + numberOfDraws + "\nNumber of Defeats : " + numberOfDefeats +
